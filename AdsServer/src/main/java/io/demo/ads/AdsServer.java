...
//		String mysql_pass = "searchads";
//		System.out.println("=========test adsserver==============");
//		MySQLAccess mySQLAccess = new MySQLAccess(mysql_host, mysql_db, mysql_user, mysql_pass);
//        try {
//            mySQLAccess.createAdTable();
//            mySQLAccess.createCampaignTable();
//        } catch (Exception e) {
//            e.printStackTrace();
//        } finally {
//            try {
