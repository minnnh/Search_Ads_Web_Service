...
public class CTRModel {
    ...
    protected CTRModel(String logistic_reg_model_file, String gbdt_model_path) {
        ...
        try {
        	System.out.println("==== in CTRModeling =====");
        	BufferedReader ctrLogisticReader = new BufferedReader(new FileReader(logistic_reg_model_file));
        	String line;
    ...
    public double predictCTRWithLogisticRegression(ArrayList<Double> features) {
        ...
        System.out.println("sigmoid ouput pClick = " + pClick);
        return pClick;
    }
}
