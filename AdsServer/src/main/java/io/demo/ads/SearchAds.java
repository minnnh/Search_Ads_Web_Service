...
public class SearchAds extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	    ...
	    // New code for h1 heading
		
	    String heading = "<h1 style=font-family: 'Arial', sans-serif; margin-bottom: 20px;>Welcome to Ads Search</h1>";
	    // New code for button/link
	    // String buttonLink = "<form action='/'><button type='submit'>Back to Search Ads</button></form>";
	    String buttonLink = "<div style='text-align: center;'><form action='/'><button type='submit' style='padding: 10px; font-size: 16px; background-color: #ebc934;'>Back to Search Ads</button></form></div>";
	    result = heading + "<br>" + buttonLink + result;
...
//		query = query.replace("$category$", query_category);
//		device_id = device_id.replace("$device_id$", device_id);
//		device_ip = device_ip.replace("$device_ip$", device_ip);
//		/*
//		 * rewrite end
//		 */
