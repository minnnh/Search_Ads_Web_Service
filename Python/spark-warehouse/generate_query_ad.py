...
if __name__ == "__main__":
    # DIR = "../../data/"
    # ad_input_file = DIR + "deduped/cleaned_ads.txt"
    # query_camp_ad_file = "query_camp_ad_file.json"
    # campaign_weight_file = "campaign_weight_file.json"
    # ad_weight_file = "ad_weight_file.json"
    # query_group_id_query_file = "query_group_id_query_file.json"
    # campaignId_category_file = "campaignId_category_file.json"
    # campaignId_adId_file = "campaignId_adId_file.json"

    # DIR = "../../data/"
    # DIR2 = "../../data2/"
    # ad_input_file = DIR + "deduped/cleaned_ads.txt"
    # query_camp_ad_file = DIR2 + "query_camp_ad_file.json"
    # campaign_weight_file = DIR2 + "campaign_weight_file.json"
    # ad_weight_file = DIR2 + "ad_weight_file.json"
    # query_group_id_query_file = DIR2 + "query_group_id_query_file.json"
    # campaignId_category_file = DIR2 + "campaignId_category_file.json"
    # campaignId_adId_file =DIR2 + "campaignId_adId_file.json"

    DIR = "../../data/"
    ad_input_file = DIR + "deduped/cleaned_ads.txt"
    query_camp_ad_file = DIR + "query_camp_ad_file.json"
    campaign_weight_file = DIR + "campaign_weight_file.json"
    ad_weight_file = DIR + "ad_weight_file.json"
    query_group_id_query_file = DIR + "query_group_id_query_file.json"
    campaignId_category_file = DIR + "campaignId_category_file.json"
    campaignId_adId_file =DIR + "campaignId_adId_file.json"
