...
if __name__ == "__main__":
    ...
    user_input_file = DIR + "/log/user_small.txt"

    query_ad_input_file = DIR + "query_camp_ad_file.json"
    campaign_weight_input_file = DIR + "campaign_weight_file.json"
    ad_weight_input_file = DIR + "ad_weight_file.json"
    ...
    click_log_output_file = DIR + "log/simulated_click_log.txt"

    # DIR = "../../data/"
    # DIR2 = "../../data2/"
    # ad_input_file = DIR + "/deduped/cleaned_ads.txt"
    # user_input_file = DIR2 + "/log/user_small.txt"

    # query_ad_input_file = DIR2 + "query_camp_ad_file.json"
    # campaign_weight_input_file = DIR2 + "campaign_weight_file.json"
    # ad_weight_input_file = DIR2 + "ad_weight_file.json"
    ...
    # click_log_output_file = DIR2 + "log/simulated_click_log_.txt"
